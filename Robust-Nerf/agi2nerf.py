...
def parse_args():
	...
	parser.add_argument("--xml_in", default="./data/nerf_llff_data/light/pose.xml", help="specify xml file location")
	parser.add_argument("--out", default="./data/nerf_llff_data/light/transforms", help="output path")
	parser.add_argument("--imgfolder", default="./data/nerf_llff_data/light/images/", help="location of folder with images")
...
if __name__ == "__main__":
	...
	with open(OUTPATH+'_train.json', "w") as f:
		json.dump(out, f, indent=4)
	with open(OUTPATH+'_test.json', "w") as f:
		json.dump(out, f, indent=4)
	with open(OUTPATH+'_val.json', "w") as f:
		json.dump(out, f, indent=4)
